...
export default function HomePage() {
  return (
    ...
    sx={{ mt: '15px'}}
    >
      <Grid container rowSpacing={{ xs: 3, sm: 4, md: 5 }} columnSpacing={{ xs: 2, sm: 2, md: 5 }}>
      <Grid item xs={12} sm={6}>
        ...
        <Grid item xs={12} sm={6}>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel hic beatae labore doloribus, quidem nihil recusandae, id ipsa magni dolore vero accusantium iure, eaque voluptatem.</p>
        </Grid>
